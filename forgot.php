...
<?php  
	if(isset ($_POST['stdsubmit']))
	{
		...
		mysqli_select_db("aptitude");
		$query = mysqli_query("SELECT * FROM STUDENT where emailid = '$email'");
		while($row = mysqli_fetch_assoc($query))
		{
			$username = $row['stdname'];
		...
		<div class="col-md-4">
			<div class="panel panel-default">
			 ...
			 <!--<div class="jumbotron text-center" style="margin-bottom:15px; padding:7px;" ><h3>Registration Form</h3></br></div> -->
				...
				<form id="forgotpassword" action="forgot.php" method="post">
